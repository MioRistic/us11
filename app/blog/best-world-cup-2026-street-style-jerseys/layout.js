...
export const metadata = {
  ...
  description:
    "Which 2026 World Cup jerseys look the best on the street? From Germany’s clean classic to Colombia’s vibrant yellow — here’s our definitive ranking of the most wearable kits.",
  openGraph: {
    title: "Best World Cup 2026 Jerseys for Street Style: The Kits Worth Buying",
    description:
      "Our ranking of the top 10 World Cup 2026 kits that actually look good on the street — not just on the pitch.",
  ...
  twitter: {
    ...
    description:
      "Ranking the top 10 most wearable kits from the 2026 World Cup — Germany, New Zealand, Japan and more.",
    images: [
      "https://assets.goal.com/images/v3/blteb5ae4bd28752ec3/adidas%20FIFA%20World%20Cup%202026%20kit%20-%20Germany.png?auto=webp&format=pjpg&width=1920&quality=60",
    ],
    creator: "@US11FC",
  },
  alternates: {
...
export default function BestWorldCup2026JerseysLayout({ children }) {
  return (
    <div className="bg-white min-h-screen">
      {/* NO max-w here – page handles full-bleed + content width */}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Ranking the top 10 most wearable World Cup 2026 jerseys perfect for everyday street style.",
          }),
        }}
      />
    </div>
