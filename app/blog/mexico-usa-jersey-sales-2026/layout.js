...
export const metadata = {
  ...
  description:
    "Fanatics claims the USMNT 2026 kit is currently the best-selling national team jersey in the United States. We break down the data, the Messi effect, and what it means for 2026.",
  openGraph: {
    title: "Mexico or USA: Whose Jersey Sells More in America?",
    description:
      "Fanatics ranking sparks debate — is the USMNT kit finally outselling Mexico in the US?",
  ...
  twitter: {
    ...
    title: "Mexico or USA: Whose Jersey Sells More in America?",
    description:
      "Fanatics data shows US kit leading sales ahead of Mexico, Canada, Brazil & Argentina.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Fanatics claims the USMNT 2026 kit is currently the best-selling national team jersey in the United States.",
          }),
        }}
      />
    </div>
