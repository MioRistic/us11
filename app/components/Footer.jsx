    ...
    <footer className='bg-black text-white py-4'>
      <div className='max-w-4xl mx-auto px-4'>
        <div className='flex justify-between items-center mb-4'>
          ...
          <div className='flex'>
            <a href='https://www.youtube.com/@us11fc' className='text-sm hover:underline mx-2'><FaYoutube size={20} /></a>
            <a href='https://www.instagram.com/us11fc/' className='text-sm hover:underline mx-2'><FaInstagram size={20} /></a>
            <a href='https://www.facebook.com/profile.php?id=61565465891580' className='text-sm hover:underline mx-2'><FaFacebook size={20} /></a>
            <a href='https://www.tiktok.com/@us11fc' className='text-sm hover:underline mx-2'><FaTiktok size={20} /></a>
            <a href='https://x.com/US11FC' className='text-sm hover:underline mx-2'><FaTwitter size={20} /></a>
            <a href='https://www.linkedin.com/company/us11' className='text-sm hover:underline mx-2'><FaLinkedin size={20} /></a>
          </div>
        </div>
