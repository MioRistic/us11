...
export default function MLSWinterTransfers() {
  ...
  const twitterShare = `https://twitter.com/intent/tweet?url=${encodeURIComponent(currentUrl)}&text=${encodeURIComponent(
    "MLS Winter 2026 Transfer Roundup – Updated Jan 30"
  )}`;
  const whatsappShare = `https://api.whatsapp.com/send?text=${encodeURIComponent("MLS Winter 2026 Transfers – full list: " + currentUrl)}`;
  ...
  January 2026 MLS Transfers: Complete List of Moves
</h1>
        ...
        <figure className="w-full rounded-2xl overflow-hidden shadow-md mb-10">
          <Image
            src="https://images.mlssoccer.com/image/private/t_editorial_landscape_8_desktop_mobile/mls/nueftpykp5147ajenan0.jpg"
        ...
        <section className="prose prose-lg max-w-none space-y-12 leading-relaxed">
          ...
          <div>
  <p>
    The first month of the 2026 MLS transfer window has already delivered a flurry of intriguing arrivals. From high-profile signings to homegrown prospects, clubs across the league are recalibrating their rosters for the season ahead.
  </p>

  <p>
    <strong>Atlanta United – Adrian Gill (Midfielder, from FC Barcelona, 1/27/26)</strong><br />
    Atlanta United made a bold statement by securing Adrian Gill from Barcelona. The young midfielder, steeped in La Masia’s philosophy, brings technical poise and intelligence rare in MLS. His adaptation to the pace and physicality of American soccer will be fascinating to track. Gill could become a central figure in Atlanta’s midfield, blending European flair with the league’s intensity.
  </p>

  <p>
    <strong>FC Cincinnati – Bryan Ramírez (Forward, from LDU Quito, 1/15/26)</strong><br />
    Cincinnati adds South American attacking talent in Bryan Ramírez. The Ecuadorian forward is known for his directness and finishing instinct. MLS has a history of players from Ecuador making an immediate impact, and Ramírez’s integration into Cincinnati’s system could provide an exciting offensive spark.
  </p>

  <p>
    <strong>FC Cincinnati – Kristian Fletcher (Forward, 1/13/26, free)</strong><br />
    A homegrown talent in all but name, Fletcher’s arrival as a free agent brings hope for a young American forward ready to take the next step. Fletcher’s speed and movement off the ball fit a league increasingly defined by athleticism and pressing intensity.
  </p>

  <p>
    <strong>FC Cincinnati – Tom Barlow (Forward, 1/12/26, free)</strong><br />
    Barlow returns to MLS, bringing experience and composure up front. His reintroduction into the league could offer stability in Cincinnati’s attacking rotation while mentoring younger players like Fletcher.
  </p>

  <p>
    <strong>Houston Dynamo – Nick Markanich (Forward, loan from CD Castellón, 1/20/26)</strong><br />
    Markanich arrives on loan from Spain, a versatile forward with a nose for goal. Houston will be watching closely to see if he can adjust to MLS defenses, which often emphasize physicality over pure technical ability. His European seasoning could pay dividends quickly if he finds the right role.
  </p>

  <p>
    <strong>Houston Dynamo – Mateusz Bogusz (Midfielder, from Cruz Azul, 1/29/26)</strong><br />
    Polish midfielder Mateusz Bogusz arrives with expectations to control tempo and link play. His creativity and passing range will be key for Houston, especially in breaking down compact defenses. MLS fans should watch how Bogusz balances flair with the league’s athletic demands.
  </p>

  <p>
    <strong>Houston Dynamo – Guilherme (Forward, from Santos FC, 1/13/26)</strong><br />
    Brazilian attacker Guilherme is a classic MLS addition: technically gifted, unpredictable, and hungry to prove himself on a new stage. His experience in the Brazilian top flight could make him a difference-maker in the Dynamo’s attacking patterns.
  </p>

  <p>
    <strong>Inter Miami CF – Tadeo Allende (Forward, from Celta de Vigo, 1/19/26)</strong><br />
    Miami continues its investment in young European talent with Allende. The Spaniard’s intelligence in the final third and comfort in tight spaces makes him a promising addition for an Inter Miami squad looking to combine possession with explosive transitions.
  </p>

  <p>
    <strong>Inter Miami CF – Daniel Pinter (Forward, homegrown, 1/21/26)</strong><br />
    Pinter is a story of the academy pathway paying dividends. The homegrown forward, already familiar with Miami’s culture and style, offers versatility and a hunger to make an immediate impact. MLS is a proving ground, and Pinter has the chance to show why his development has been closely monitored.
  </p>

  <p>
    <strong>Minnesota United FC – Marcus Caldeira (Forward, SuperDraft, 1/28/26)</strong><br />
    Caldeira’s arrival via the SuperDraft underscores Minnesota’s commitment to youth and domestic talent. The forward brings athleticism, pressing ability, and potential that could see him emerge as a breakout talent this season.
  </p>

  <p>
    <strong>San Jose Earthquakes – Timo Werner (Forward, from RB Leipzig, 1/29/26)</strong><br />
    Arguably the most high-profile January transfer, Werner’s arrival in San Jose immediately shifts expectations. A forward with experience at the highest European level, his adaptation to MLS’s unique style will be a storyline to watch. Will Werner dominate with technical superiority, or will the league’s physicality and travel demands challenge him in unexpected ways?
  </p>
</div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>M - Adrian Gill (1/27/26 - transfer from FC Barcelona)</li>
            </ul>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Jáder Obrian (1/27/26 - waived)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Henry Kessler (1/29/26 - free agent)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>GK - Alex Bono (1/26/26 - trade from New England Revolution)</li>
              <li>D - Silvan Hefti (1/29/26 - transfer from Hamburger SV)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Franco Negri (1/27/26 - free agent)</li>
              <li>M - Mateusz Bogusz (1/29/26 - transfer from Cruz Azul)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - João Klauss (1/27/26 - trade from St. Louis CITY SC)</li>
              <li>M - Erik Thommy (1/28/26 - free agent)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Germán Berterame (1/30/26 - transfer from CF Monterrey)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Marcus Caldeira (1/28/26 - SuperDraft)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>GK - Alex Bono (1/26/26 - trade to D.C. United)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Kai Trewin (1/27/26 - transfer from Melbourne City FC)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Julián Fernández (1/27/26 - loan to Rosario Central)</li>
              <li>F - Jovan Mijatović (1/29/26 - loan to Eintracht Braunschweig)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>GK - Ethan Horvath (1/29/26 - transfer from Cardiff City)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Marcelo Morales (1/28/26 - loan to Universidad de Chile)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>M - Stijn Spierings (1/25/26 - transfer from Brøndby IF)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Rwan Cruz (1/27/26 - mutual contract termination)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Paddy McNair (1/28/26 - transfer to Hull City)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Tomo Allen (1/26/26 - homegrown)</li>
              <li>F - Timo Werner (1/29/26 - transfer from RB Leipzig)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Rafael Santos (1/27/26 - free agent)</li>
              <li>D - Mamadou Mbacke Fall (1/29/26 - transfer from FC Barcelona)</li>
              <li>M - Dante Polvara (1/30/26 - transfer from Aberdeen FC)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - João Klauss (1/27/26 - trade to LA Galaxy)</li>
            </ul>
          </div>
          ...
          <div className="border-t pt-8">
            ...
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>F - Bruno Caicedo (1/30/26 - transfer from Barcelona SC)</li>
              <li>M - Aziel Jackson (1/30/26 - loan from Jagiellonia Białystok)</li>
            </ul>
            <h3 className="text-2xl font-semibold mt-6 mb-2">Players Out</h3>
            <ul className="list-disc ml-6 space-y-1">
              ...
              <li>D - Joedrick Pupe (1/29/26 - loan to Sint-Truidense VV)</li>
            </ul>
          </div>

          <p className="italic text-center mt-16 text-lg">
  The transfer window remains open until the end of March 2026 – more changes are expected in the coming weeks! All information is sourced from the official MLS website, <a href="https://www.mlssoccer.com" target="_blank" rel="noopener noreferrer">mlssoccer.com</a>.
</p>
