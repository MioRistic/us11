...
const CFMontrealPage = () => {
  ...
  const players = [
    ...
    // { 
    //   name: 'Prince Owusu', 
    //   image: 'https://via.placeholder.com/400x300?text=Prince+Owusu', 
    //   slug: 'owusu' 
    // },
    // { 
    //   name: 'Iván Jaime', 
    //   image: 'https://via.placeholder.com/400x300?text=Ivan+Jaime', 
    //   slug: 'jaime' 
    // },
  ];
  ...
  const squad = {
    ...
    defenders: [
      "Jalen Neal", "Tomás Avilés", "Brayan Vera", "Brandan Craig",
      "Luca Petrasso", "Bode Hidalgo", "Dawid Bugaj", "Josh Nteziryayo"
    ],
    midfielders: [
      "Samuel Piette", "Matty Longstaff", "Victor Loturi", "Frankie Amaya",
      "Ivan Losenko", "Olger Escobar", "Andre Dozzell"
    ],
    attackers: [
      "Kwadwo Opoku", "Prince Owusu", "Iván Jaime", "Daniel Ríos",
      "Sunusi Ibrahim", "Owen Graham-Roache"
    ],
    headCoach: "Philippe Eullaffroy (interim)"
  };
    ...
    <div className="bg-white min-h-screen text-[#0d1117]">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2 space-y-10 md:space-y-12">
            ...
            <>
              <div className="bg-gray-50 p-6 md:p-8 rounded-2xl shadow-sm">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-lg">
                  ...
                  <div><dt className="font-bold text-gray-600">Stadium</dt><dd>Stade Saputo, Montreal</dd></div>
                  ...
                  <div><dt className="font-bold text-gray-600">Head Coach</dt><dd>Philippe Eullaffroy (interim)</dd></div>
                </dl>
              </div>
          ...
          {activeTab === 'news' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">CF Montréal News</h2>
          ...
          {activeTab === 'blog' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">CF Montréal Blog</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {blogPosts.map((post) => (
          ...
          {activeTab === 'squad' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">CF Montréal Squad 2026</h2>
              ...
              <div>
                <h3 className="text-2xl font-bold text-blue-600 mb-4 border-b border-gray-200 pb-2">Head Coach</h3>
                <div className="bg-gray-50 px-5 py-4 rounded-xl font-medium inline-block">
                  Philippe Eullaffroy (interim)
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'shop' && (
            <div>
              ...
              <div className="mt-12 text-center">
                <a 
                  href="https://mlsstore.i8h2.net/m4EN71" 
                  target="_blank" 
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <a href="https://expedia.com/affiliate/3IVO0Ln" target="_blank" rel="noopener noreferrer" 
                className="flex items-center gap-3 bg-white/20 hover:bg-white/30 px-6 py-4 rounded-xl font-bold transition text-center justify-center">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl shadow-sm">
            ...
            <div className="mt-6 text-center">
              <a href="https://mlsstore.i8h2.net/m4EN71" target="_blank" className="text-blue-600 font-bold hover:underline">
                View Full Shop →
              </a>
            </div>
          </div>
