...
const DCUnitedPage = () => {
  ...
  const players = [
    ...
    // { 
    //   name: 'Tai Baribo', 
    //   image: 'https://via.placeholder.com/400x300?text=Tai+Baribo', 
    //   slug: 'baribo' 
    // },
  ];
  ...
  const squad = {
    goalkeepers: ["Sean Johnson", "Alex Bono", "Jordan Farr", "Grant Leveille"],
    defenders: [
      "Lucas Bartlett", "Silvan Hefti", "Keisuke Kurokawa", "Conner Antley",
      "Sean Nealis", "Kye Rowles", "Aaron Herrera", "Nikola Markovic"
    ],
    midfielders: [
      "Matti Peltola", "Gabriel Pirani", "Brandon Servania", "Jackson Hopkins",
      "Caden Clark", "Hosei Kijima", "Gavin Turner", "Andre Dozzell"
    ],
    attackers: [
      "João Peglow", "Jared Stroud", "Tai Baribo", "Louis Munteanu",
      "Gabriel Segal", "Jacob Murrell", "Hakim Karamoko", "Oscar Avilez"
    ],
    headCoach: "René Weiler"
  };
    ...
    <div className="bg-white min-h-screen text-[#0d1117]">
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className="flex items-center gap-5 md:gap-6 mb-4">
              <div className="w-24 h-24 md:w-40 md:h-40 relative bg-white rounded-2xl p-4 shadow-2xl flex items-center justify-center">
                <Image
                  src="https://upload.wikimedia.org/wikipedia/en/thumb/3/32/D.C._United_logo_%282016%29.svg/960px-D.C._United_logo_%282016%29.svg.png"
                  alt="D.C. United Logo"
                  width={160}
                  height={160}
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2 space-y-10 md:space-y-12">
            ...
            <>
              <div className="bg-gray-50 p-6 md:p-8 rounded-2xl shadow-sm">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-lg">
                  ...
                  <div><dt className="font-bold text-gray-600">Head Coach</dt><dd>René Weiler</dd></div>
                </dl>
              </div>
          ...
          {activeTab === 'news' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">D.C. United News</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {newsPosts.map((post) => (
                  <Link key={post.id} href={`/news/${post.slug}`} className="group">
                    <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all">
          ...
          {activeTab === 'blog' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">D.C. United Blog</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {blogPosts.map((post) => (
          ...
          {activeTab === 'squad' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">D.C. United Squad 2026</h2>
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-red-600 to-red-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <a href="https://expedia.com/affiliate/mT8uDEi" target="_blank" rel="noopener noreferrer" 
                className="flex items-center gap-3 bg-white/20 hover:bg-white/30 px-6 py-4 rounded-xl font-bold transition text-center justify-center">
