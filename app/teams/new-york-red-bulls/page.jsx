...
const RedBullNewYorkPage = () => {
  ...
  const shopItems = [
    {
      ...
      link: "https://mlsstore.i8h2.net/k4MVLx"
    },
    {
      id: 2,
  ...
  const squad = {
    goalkeepers: ["AJ Marcucci", "Ethan Horvath", "Aidan Stokes", "John McCarthy"],
    defenders: [
      "Justin Che", "Jahkeele Marshall-Rutty", "Omar Valencia", "Robert Voloder",
      "Dylan Nealis", "Julián Bazán", "Juan José Mina", "Tim Parker",
      "Joyeux Masanka Bungi", "Matthew Dos Santos"
    ],
    midfielders: [
      "Gustav Berggren", "Emil Forsberg", "Adri Mehmeti", "Ronald Donkor",
      "Aiden Jarvis", "Mohammed Sofo", "Nehuén Benedetti", "Rafael Mosquera"
    ],
    attackers: [
      "Cade Cowell", "Jorge Ruvalcaba", "Eric Maxim Choupo-Moting", "Julian Hall",
      "Cameron Harper", "Dennis Gjengaar", "Roald Mitchell", "Tanner Rosborough",
      "Andy Rojas"
    ],
    headCoach: "Michael Bradley"
  };
  ...
  return (
    <div className="bg-white min-h-screen text-[#0d1117]">
      ...
      <div className="relative h-[480px] md:h-[620px] bg-gradient-to-b from-black/70 to-black/90 overflow-hidden">
        <Image src="/rb.png" alt="Red Bull New York" fill className="object-cover" priority />
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2 space-y-12">
            ...
            <>
              <div className="bg-gray-50 p-8 rounded-2xl shadow-sm">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-lg">
                  ...
                  <div><dt className="font-bold text-gray-600">Stadium</dt><dd>Red Bull Arena</dd></div>
                  <div><dt className="font-bold text-gray-600">Head Coach</dt><dd>Michael Bradley</dd></div>
                </dl>
              </div>
          ...
          {activeTab === 'squad' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">Squad 2026</h2>
          ...
          {activeTab === 'shop' && (
            <div>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-3xl font-black text-[#020617]">Red Bulls Shop</h2>
              </div>
              ...
              <div className="mt-12 text-center">
                <a href="https://mlsstore.i8h2.net/k4MVLx" target="_blank" 
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-red-600 to-red-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <a href="https://expedia.com/affiliate/fxajPJd" target="_blank" rel="noopener noreferrer" 
                className="flex items-center gap-3 bg-white/20 hover:bg-white/30 px-6 py-4 rounded-xl font-bold transition text-center justify-center">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl shadow-sm">
            ...
            <div className="mt-6 text-center">
              <a href="https://mlsstore.i8h2.net/k4MVLx" target="_blank" className="text-red-600 font-bold hover:underline">
                View Full Shop →
              </a>
            </div>
          </div>
