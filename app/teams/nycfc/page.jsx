...
const NYCFCPage = () => {
  ...
  const shopItems = [
    {
      ...
      link: "https://mlsstore.i8h2.net/OYKzkG"
    },
    {
      id: 2,
  ...
  const squad = {
    goalkeepers: ["Matt Freese", "Tomás Romero", "Mac Learned"],
    defenders: [
      "Nico Cavallo", "Kai Trewin", "Thiago Martins", "Tayvon Gray",
      "Strahinja Tanasijević", "Kevin O'Toole", "Andrew Farrell"
    ],
    midfielders: [
      "Maxi Moralez", "Andres Perea", "Keaton Parks", "Kevin Pierre",
      "Aiden O'Neill", "Máximo Carrizo", "Jonathan Shore"
    ],
    attackers: [
      "Talles Magno", "Alonso Martínez", "Agustin Ojeda", "Malachi Jones",
      "Seymour Garfield-Reid"
    ],
    headCoach: "Pascal Jansen"
  };
  ...
  return (
    <div className="bg-white min-h-screen text-[#0d1117]">
      ...
      {/* Navigation Tabs - Plava boja NYCFC */}
            ...
            {['overview', 'news', 'blog', 'squad', 'shop'].map((tab) => (
              <button 
                ...
                className={`font-bold text-base md:text-lg pb-2 transition relative flex-shrink-0
                  ${activeTab === tab ? 'text-blue-600' : 'text-white/80 hover:text-white'}`}
              >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-2 space-y-10 md:space-y-12">
            ...
            <>
              <div className="bg-gray-50 p-6 md:p-8 rounded-2xl shadow-sm">
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-lg">
                  ...
                  <div><dt className="font-bold text-gray-600">Stadium</dt><dd>Yankee Stadium, The Bronx</dd></div>
          ...
          {activeTab === 'news' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">NYCFC News</h2>
          ...
          {activeTab === 'blog' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">NYCFC Blog</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {blogPosts.map((post) => (
          ...
          {activeTab === 'squad' && (
            <div>
              <h2 className="text-3xl font-black mb-8 text-[#020617]">New York City FC Squad 2026</h2>
          ...
          {activeTab === 'shop' && (
            <div>
              ...
              <div className="mt-12 text-center">
                <a 
                  href="https://mlsstore.i8h2.net/OYKzkG" 
                  target="_blank" 
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <a href="https://expedia.com/affiliate/KHvr9Hq" target="_blank" rel="noopener noreferrer" 
                className="flex items-center gap-3 bg-white/20 hover:bg-white/30 px-6 py-4 rounded-xl font-bold transition text-center justify-center">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl shadow-sm">
            ...
            <div className="mt-6 text-center">
              <a href="https://mlsstore.i8h2.net/OYKzkG" target="_blank" className="text-blue-600 font-bold hover:underline">
                View Full Shop →
              </a>
            </div>
          </div>
